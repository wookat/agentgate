...
Canonical JSON Schema: [`docs/spec/agentgate.lock.schema.json`](https://github.com/wookat/agentgate/blob/main/docs/spec/agentgate.lock.schema.json) (a cross-route contract per `docs/ROUTES.md`; changes are coordinated in PRs).
...
| Field | Description |
|---|---|
| `lockfileVersion` | Format version; this page documents version `1` (the only accepted value). |
