...
| Curated MCP advisory database | yes — [108 public advisories](/advisories/), bundled for offline use + live API | no public equivalent found | OSV covers registry malware, not MCP-server CVEs as a category |
