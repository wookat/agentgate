...
Supported clients: `claude-desktop`, `claude-code`, `cursor`, `vscode`, `codex`, `opencode`, `windsurf`, `cline`, `gemini-cli`, `kiro`, `roo-code`, `kilocode`, `kilo`, `zed`, `continue`, `amp`, `warp`, `lmstudio`, `trae`, `amazonq`, `antigravity`, `crush`, `goose`, `factory`, `junie`, `qoder`, `qwen-code`, `copilot-cli`.
