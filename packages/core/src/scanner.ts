...
const AGENT_DOT_DIRS = new Set(['.agents', '.agent', '.claude', '.cursor', '.codex', '.opencode', '.windsurf', '.cline', '.clinerules', '.gemini', '.continue', '.trae', '.kiro', '.roo', '.github', '.amazonq', '.vscode', '.zed', '.claude-plugin', '.qwen', '.plugin', '.junie', '.openhands', '.factory', '.factory-plugin']);
